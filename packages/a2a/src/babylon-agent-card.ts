  ...
  skills: [
    {
      ...
      description:
        'Create posts, read feed, like, comment, share content in the Babylon social game.',
    ...
    },
    {
      ...
      description:
        'Trade binary prediction markets. Buy YES/NO shares, manage positions.',
    ...
    },
    {
      ...
      description:
        'Search users, follow/unfollow, view profiles, manage social connections.',
    ...
    },
    {
      ...
      description:
        'View leaderboards, statistics, trending content, reputation scores.',
    ...
    },
    {
      ...
      description:
        'Check balance, view positions, transfer points, manage wallet.',
    ...
    },
    {
      ...
      description:
        'Admin-only: Create escrow payments, verify payments, refund escrows. Users can appeal bans using escrow payments.',
