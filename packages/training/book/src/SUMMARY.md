...
- [Archetype System](./architecture/archetype-system.md)
...
- [Training Modes](./training-pipeline/modes.md)
- [GRPO & Atropos](./training-pipeline/grpo-atropos.md)
- [Trajectory Format](./training-pipeline/trajectory-format.md)
- [GPU Profiles](./training-pipeline/gpu-profiles.md)
...
- [Local Training](./operations/local-training.md)
...
- [Testing Tiers](./development/testing-tiers.md)
- [Adding Archetypes](./development/adding-archetypes.md)
...
- [Environment Variables](./appendix/env-vars.md)
