 ...
 * Import this before using ParallelTrajectoryGenerator or other training services.
 *
 * Usage:
...
export async function initializeTrainingPackage(): Promise<void> {
  ...
  try {
    ...
    const agentService = agentsModule.agentService as unknown as IAgentService;
    ...
    throw new Error(`Training package initialization failed: ${message}`);
  }
}
