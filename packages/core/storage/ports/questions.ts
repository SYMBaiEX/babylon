...
export interface QuestionPort {
  ...
  createQuestion(question: Omit<QuestionRecord, 'id' | 'createdAt' | 'updatedAt'>): Promise<QuestionRecord>;
  resolveQuestion(id: string, resolvedOutcome: boolean): Promise<QuestionRecord>;
  updateQuestion(id: string, updates: Partial<QuestionRecord>): Promise<QuestionRecord>;
