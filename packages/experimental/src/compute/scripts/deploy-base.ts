/**
 * Deploy Compute Marketplace to Base (Sepolia or Mainnet)
 *
 ...
 *
 * Usage:
 *   Base Sepolia: NETWORK=sepolia bun run src/compute/scripts/deploy-base.ts
 *   Base Mainnet: NETWORK=mainnet bun run src/compute/scripts/deploy-base.ts
 */
...
async function deploy(): Promise<DeploymentResult> {
  ...
  console.log(`\n🚀 Deploying Babylon Compute Marketplace\n`);
