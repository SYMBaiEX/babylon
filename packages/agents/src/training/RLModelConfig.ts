 ...
 * Allows different trained models per agent archetype for true multi-agent diversity
 */
 ...
 * Falls back to null if no archetype-specific model exists (caller should use base model)
 */
