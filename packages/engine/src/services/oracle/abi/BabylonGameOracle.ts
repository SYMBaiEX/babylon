/**
 * ABI for the BabylonGameOracle contract
 * Extracted from packages/contracts/src/game/BabylonGameOracle.sol
 */
export const BabylonGameOracleABI = [
  {
    ...
    outputs: [
      {
        ...
        internalType: 'struct BabylonGameOracle.GameMetadata',
        name: 'metadata',
        type: 'tuple',
      },
      {
        ...
        internalType: 'struct PredictionOracle.GameOutcome',
        name: 'game',
        type: 'tuple',
      },
    ],
