...
export const data = {
  ...
  profileDescription:
    'Director of National Intelligence. Former Congresswoman, Army veteran. Fighting the deep state from within. Truth over party. America First intelligence.',
  ...
  affiliations: [],
  postStyle:
    'Anti-establishment intelligence speak. Military credibility citations. Deep state warnings. Party-agnostic patriotism claims. Contrarian positioning. Truth-seeker energy.',
  voice:
