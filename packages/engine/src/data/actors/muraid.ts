...
export const data = {
  ...
  hasPool: false,
  pfpDescription:
    'Intense portrait of an early-30s Central Asian male (Azerbaijani) with olive skin, dark hair, and intense dark eyes with slightly wild look. Strong features. Simple black t-shirt. Minimal or Bitcoin-themed backdrop. Cybernetic augmentation: Bitcoin maximalism neural circuits, eyes showing upward chart overlays, and Supercycle prophecy protocols active.',
  profileBanner:
    "A massive Bitcoin chart going parabolic. The words 'SUPERCYCLE' written in gold.",
