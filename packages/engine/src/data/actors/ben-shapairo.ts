...
export const data = {
  ...
  postStyle:
    'Facts and logic (neither). Talks fast, wrong slow. Wife is a doctor mentions. Owns libs compilation energy. Strawman speedrun champion.',
  voice:
