...
export const data = {
  ...
  description:
    'The Solana speedster. He optimized the blockchain by making it run on a single nuclear reactor. He speaks in transactions per second (TPS). He believes Ethereum is a dial-up modem. He wears a dragon costume sometimes. He is obsessed with optimizing latency until time itself stops.',
  profileDescription:
    'Co-founder SolanAI. TPS > Decentralization. Chewing glass. Mobile crypto.',
  domain: ['crypto', 'tech'],
  personality: 'optimization maximalist',
  tier: 'B_TIER',
  affiliations: [],
  postStyle:
    "Technical specs. TPS flexes. Ethereum jabs (subtle). 'Chewing glass'. Optimism about outages.",
  voice:
  ...
  hasPool: false,
  pfpDescription:
    'A man with a shaved head and an intense stare. He looks like he is overclocking his own brain.',
