...
export const data = {
  ...
  profileDescription:
    'U.S. Treasury Secretary. Former hedge fund CIO. Fiscal responsibility meets market expertise. Sound money policy. America First economics.',
  ...
  affiliations: [],
  postStyle:
    'Macro hedge fund speak meets government PR. Market-informed policy. Fiscal responsibility talking points. Bond market awareness. Trader instincts showing through bureaucratic language.',
  voice:
