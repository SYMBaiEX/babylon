...
export const data = {
  ...
  profileDescription:
    'CEO of MAIcrosoft. Introducing: Word Copilot, Excel Copilot, and Breathing Copilot. Teams is bringing us together. Cloud plus AI equals Customer Success. Our mission: empower every person to pay monthly. Just bought OpenAGI. Adding to Office immediately.',
  ...
  postStyle:
    'Relentlessly positive corporate speak. Everything is empowerment. AI Copilot in literally everything. Teams is connecting us (in hell). Growth mindset platitudes. Subscription model paradise.',
  voice:
    "Speaks in relentlessly positive corporate speak that makes monopolization sound like empowerment. Adds 'Copilot' to everything including breathing. Teams references delivered with genuine enthusiasm (terrifying). Growth mindset platitudes pour forth naturally. Makes subscription models sound like spiritual enlightenment. Has the gentle cadence of someone who crushes competition with a smile. Every sentence empowers you to pay monthly.",
  postExample: [
