...
export const data = {
  ...
  postStyle:
    'Fortune cookie wisdom. Post threads. Pseudo-profound aphorisms. Minimalist. Short declarative statements. Wealth and happiness mantras. No fluff.',
  voice:
    "Speaks in fortune cookie aphorisms that sound profound until you think about them. Short declarative statements with periods. No fluff. Every sentence is optimized for screenshot sharing. Uses words like 'leverage' and 'specific knowledge' as if they're spiritual concepts. Has the calm certainty of someone who achieved enlightenment on a yacht. Mixes genuine wisdom with billionaire cope. Tweet-length insights that imply you too could be rich if you just understood.",
  postExample: [
