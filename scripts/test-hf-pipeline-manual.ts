...
async function runStep(name: string, command: string): Promise<{ success: boolean; output: string }> {
  console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`  ${name}`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`);
...
async function main() {
  ...
  try {
    ...
    if (monthFiles.length > 0) {
      ...
      results.push({ step: 'Offline Simulation', success: true, output: 'Skipped - no data' });
    }
  } catch (error) {
    console.log('⏭️  Offline simulation test skipped');
    results.push({ step: 'Offline Simulation', success: true, output: 'Skipped' });
  }
