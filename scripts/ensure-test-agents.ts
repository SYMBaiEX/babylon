...
async function main() {
  ...
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
  console.log(
    `Setting up ${TEST_AGENT_CONFIGS.length} test agents for benchmarking...`
  );
  ...
  console.log(
    '   bun run scripts/run-baseline-benchmarks.ts --benchmark=benchmarks/benchmark-week-10080-60-10-5-8-12345.json\n'
  );
