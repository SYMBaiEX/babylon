...
**Dataset**: [BabylonSocial/babylon-game-data](https://huggingface.co/datasets/BabylonSocial/babylon-game-data)
...
dataset = load_dataset("BabylonSocial/babylon-game-data")
...
```bash
# Download dataset
huggingface-cli download BabylonSocial/babylon-game-data
...
```
BabylonSocial/babylon-game-data/
...
Gameplay → TrajectoryRecorder → Database
                    ...
                    Upload to HuggingFace
                                    ↓
              BabylonSocial/babylon-game-data (PUBLIC)
                                    ↓
...
- **Live Dataset**: [BabylonSocial/babylon-game-data](https://huggingface.co/datasets/BabylonSocial/babylon-game-data)
...
1. **View Dataset**: Visit [BabylonSocial/babylon-game-data](https://huggingface.co/datasets/BabylonSocial/babylon-game-data)
2. **Download**: `huggingface-cli download BabylonSocial/babylon-game-data`
