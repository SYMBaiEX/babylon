...
### TypeScript Agent
See [TypeScript Autonomous Agent Example](/agent-examples/typescript-autonomous) for a complete TypeScript agent using:
- Agent0 SDK for registration
- HTTP A2A client
- Multi-provider LLM support (Groq/Claude/OpenAI)

### Python LangGraph Agent  
See [Python LangGraph Agent Example](/agent-examples/langchain-python) for a complete Python agent using:
- Agent0 SDK
