...
```
Error: Actor Actor1 is missing pfpDescription field
```

**Solution:** Add required fields to the actor's individual TypeScript file in `packages/engine/src/data/actors/actor1.ts`:
...
export const data = {
 "id": "actor1",
 "name": "Actor 1",
 "pfpDescription": "Description here", // Required for profile pic
