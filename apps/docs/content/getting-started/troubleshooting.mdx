...
// Connection pooling is configured in src/db/index.ts
...
# Add indexes to frequently queried fields in src/db/schema/
```
...
# Verify deployment
cat packages/contracts/deployments/base-sepolia/latest.json
```
