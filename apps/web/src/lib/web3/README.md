...
After deployment, the script saves addresses to `packages/contracts/deployments/base-sepolia/latest.json` or `packages/contracts/deployments/base/latest.json`.
...
1. Verify contracts are deployed: check `packages/contracts/deployments/` folder
