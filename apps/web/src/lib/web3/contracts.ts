...
export const LOCAL_CONTRACTS: Web3ContractAddresses = {
  identityRegistry: (localDeployment.contracts.identityRegistry ||
    '0x0000000000000000000000000000000000000000') as Address,
  reputationSystem: (localDeployment.contracts.reputationSystem ||
    '0x0000000000000000000000000000000000000000') as Address,
  diamond: (localDeployment.contracts.diamond ||
    '0x0000000000000000000000000000000000000000') as Address,
  predictionMarketFacet: (localDeployment.contracts.predictionMarketFacet ||
    '0x0000000000000000000000000000000000000000') as Address,
  oracleFacet: (localDeployment.contracts.oracleFacet ||
    '0x0000000000000000000000000000000000000000') as Address,
};
