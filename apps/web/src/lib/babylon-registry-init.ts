        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              amount: {
                type: 'number',
                description: 'Amount of shares to sell',
              },
            },
            required: ['marketId', 'amount'],
          },
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ticker: {
                type: 'string',
                description: 'Perpetual market ticker',
              },
              side: {
                type: 'string',
                enum: ['long', 'short'],
        ...
        // Social Features
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              prediction: {
                type: 'object',
                description: 'Optional prediction data',
              },
            },
            required: ['content'],
          },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              chatId: {
                type: 'string',
                description: 'Chat ID or user ID for DM',
              },
            },
            required: ['chatId'],
          },
