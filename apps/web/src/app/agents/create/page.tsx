    ...
    const loadTemplate = async () => {
      ...
      try {
        ...
        setAgentData({
          ...
          personality:
            'Analytical and precise. Communicates with confidence while acknowledging uncertainty. Focuses on data-driven insights.',
          tradingStrategy:
            'Combines technical and fundamental analysis. Uses risk management with position sizing. Monitors key indicators and market sentiment.',
          initialDeposit: 100,
        });
