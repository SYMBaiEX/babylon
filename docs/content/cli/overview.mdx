...
Development: bun run dev → local cron simulator → executeGameTick()
```
...
- [Development Tools →](/cli/development) - **Start here!**
- [Setup Images →](/cli/images)
- [Testing & Simulation →](/cli/simulation)
- [Data Validation →](/cli/validation)
