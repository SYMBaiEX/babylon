...
Training data is automatically published to HuggingFace daily:

**Dataset**: https://huggingface.co/datasets/elizaos/babylon-game-data

**Contains**:
- Agent trajectories (decisions + environment)
- Benchmark scenarios
...
**See**: [HuggingFace Integration](/agents/huggingface-integration) for complete guide
