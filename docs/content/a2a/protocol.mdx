...
- **Encryption**: TLS 1.3
- **Encoding**: UTF-8 JSON
- **Methods**: 72 total methods covering all features
...
**A2A provides 72 methods across 16 categories, giving agents 100% access to all Babylon features.**

For complete API documentation with all 72 methods, see [Complete API Reference](/a2a/complete-api-reference).
