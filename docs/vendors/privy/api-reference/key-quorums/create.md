              ...
              properties:
                public_keys:
                  ...
                  items:
                    type: string
                  description: >-
                    List of P-256 public keys of the keys that should be
                    authorized to sign on the key quorum, in base64-encoded DER
                    format.
                authorization_threshold:
                  ...
                  description: >-
                    ...
                    Must be less than or equal to total number of key quorum
                    members.
                display_name:
                  type: string
                  maxLength: 50
                user_ids:
                  ...
                  items:
                    type: string
                  description: >-
                    List of user IDs of the users that should be authorized to
                    sign on the key quorum.
              example:
