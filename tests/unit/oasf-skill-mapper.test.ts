...
describe('OASF Skill Mapper', () => {
  ...
  describe('validateOASFSkillPath', () => {
    it('should validate correct skill paths', () => {
      ...
      expect(validateOASFSkillPath('data_analysis/predictive_analytics/forecasting')).toBe(true)
    })
  ...
  describe('validateOASFDomainPath', () => {
    it('should validate correct domain paths', () => {
      ...
      expect(validateOASFDomainPath('finance_and_business/trading_and_markets')).toBe(true)
    })
  ...
  describe('Integration tests', () => {
    it('should provide valid OASF paths for all NPC types', () => {
      const npcTypes = ['trader', 'analyst', 'investor', 'influencer', 'moderator']
    ...
    it('should map complex actor data correctly', () => {
      const actorData: ActorData = {
        ...
        role: 'Market Analyst',
        description: 'Expert trader with social media presence and content creation skills. Specializes in prediction markets and investment analysis.',
      }
