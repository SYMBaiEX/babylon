...
describe('Dynamic Kick Probability System', () => {
  describe('Inactive Users (never posted)', () => {
    test('should have 90% kick probability for never posting', () => {
      ...
      expect(result.probability).toBe(0.90);
    ...
    test('should categorize as inactive regardless of group size', () => {
      // Small group
      const small = NPCGroupDynamicsService.calculateKickProbability(0, 10, 3, 7);
      expect(small.category).toBe('inactive');
      
      // Large group
      const large = NPCGroupDynamicsService.calculateKickProbability(0, 500, 50, 7);
  ...
  describe('Safe Zone (ideal participation)', () => {
    test('should have 0% kick probability for ideal participation in active group', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(5, 70, 10, 7);
    ...
    test('should be safe at exactly ideal minimum', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(5, 100, 10, 7);
    ...
    test('should be safe at exactly ideal maximum', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(15, 100, 10, 7);
  ...
  describe('Low Participation', () => {
    test('should penalize low participation in active groups', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(1, 200, 10, 7);
    ...
    test('should NOT penalize low participation in quiet groups', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(1, 15, 10, 7);
    ...
    test('kick probability should scale with how far below minimum', () => {
      ...
      const veryLow = NPCGroupDynamicsService.calculateKickProbability(1, 200, 10, 7);
      const slightlyLow = NPCGroupDynamicsService.calculateKickProbability(4, 200, 10, 7);
  ...
  describe('Over-posting', () => {
    test('should penalize posting more than 150% of fair share', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(20, 100, 10, 7);
    ...
    test('kick probability should increase exponentially with excess messages', () => {
      ...
      const slight = NPCGroupDynamicsService.calculateKickProbability(20, 100, 10, 7);
      const moderate = NPCGroupDynamicsService.calculateKickProbability(25, 100, 10, 7);
      const heavy = NPCGroupDynamicsService.calculateKickProbability(28, 100, 10, 7);
    ...
    test('over-posting probability should start low and increase', () => {
      ...
      const barelyOver = NPCGroupDynamicsService.calculateKickProbability(16, 100, 10, 7);
      const moreOver = NPCGroupDynamicsService.calculateKickProbability(20, 100, 10, 7);
  ...
  describe('Spam Behavior', () => {
    test('should have very high kick probability for spam', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(40, 100, 10, 7);
    ...
    test('spam probability should approach but not exceed 99%', () => {
      // Extreme spammer
      const extremeSpam = NPCGroupDynamicsService.calculateKickProbability(200, 100, 10, 7);
    ...
    test('absolute spam threshold (20 messages/day) should trigger', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(150, 20, 2, 7);
  ...
  describe('Dynamic Thresholds Based on Group Size', () => {
    test('small groups should have appropriate thresholds', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(8, 30, 3, 7);
    ...
    test('large groups should have appropriate thresholds', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(8, 500, 50, 7);
    ...
    test('domination threshold should be relative to group size', () => {
      ...
      const smallGroup = NPCGroupDynamicsService.calculateKickProbability(20, 30, 3, 7);
      ...
      const largeGroup = NPCGroupDynamicsService.calculateKickProbability(20, 500, 50, 7);
      ...
      if (largeGroup.category !== 'safe') {
        expect(smallGroup.probability).toBeGreaterThanOrEqual(largeGroup.probability);
      }
    });
  });
  ...
  describe('Edge Cases', () => {
    test('should handle empty groups', () => {
      const result = NPCGroupDynamicsService.calculateKickProbability(0, 0, 0, 7);
    ...
    test('should handle single-message groups', () => {
      ...
      const result = NPCGroupDynamicsService.calculateKickProbability(1, 1, 5, 7);
    ...
    test('probability should never exceed 1', () => {
      // Extreme case
      const result = NPCGroupDynamicsService.calculateKickProbability(10000, 100, 10, 7);
    ...
    test('probability should never be negative', () => {
      ...
      for (const [userMsgs, totalMsgs, participants, days] of scenarios) {
        const result = NPCGroupDynamicsService.calculateKickProbability(
          userMsgs, totalMsgs, participants, days
        );
