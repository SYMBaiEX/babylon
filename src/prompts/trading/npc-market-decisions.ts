...
const TRADING_EXAMPLES: TradingExample[] = [
  ...
  },
  {
    ...
    npcId: 'npc-b',
    npcName: 'NPC_B',
    reasoning: 'Positive insider info suggests COMPANY_A will announce positive news',
    action: 'open_long',
    marketType: 'perp',
    ticker: 'TICKER_A',
    marketId: 'null',
  ...
  },
  {
    ...
    npcId: 'npc-e',
    npcName: 'NPC_E',
    reasoning: 'Negative sentiment from feed posts suggests COMPANY_B will miss targets',
    action: 'open_short',
    marketType: 'perp',
    ticker: 'TICKER_B',
    marketId: 'null',
