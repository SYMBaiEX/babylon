...
import { BenchmarkDataGenerator, type BenchmarkConfig, type BenchmarkGameSnapshot } from '../BenchmarkDataGenerator';

// New components
import { MODEL_REGISTRY, getModelById, getBaselineModels, validateModelId } from '../ModelRegistry';
import { BenchmarkChartGenerator, type ModelComparisonData } from '../BenchmarkChartGenerator';
...
describe('Chart Generation', () => {
  it('should generate terminal chart', () => {
    ...
    const chart = BenchmarkChartGenerator.generateTerminalChart('Test Chart', data);
  ...
  it('should generate HTML report', async () => {
    ...
    const outputPath = await BenchmarkChartGenerator.generateReport(results, reportPath, {
      title: 'Test Report',
