...
export function generateNameVariations(
  ...
  const firstTitle = firstName.charAt(0).toUpperCase() + firstName.slice(1).toLowerCase();
  const lastTitle = lastName.charAt(0).toUpperCase() + lastName.slice(1).toLowerCase();
