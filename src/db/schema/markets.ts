...
export const questions = pgTable(
  'Question',
  {
    ...
    createdDate: timestamp('createdDate', { mode: 'date' }).notNull().defaultNow(),
...
export type PredictionPriceHistory = typeof predictionPriceHistories.$inferSelect;
export type NewPredictionPriceHistory = typeof predictionPriceHistories.$inferInsert;
