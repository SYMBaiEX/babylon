...
export const chatParticipants = pgTable(
  ...
  (table) => [
    ...
    index('ChatParticipant_chatId_isActive_idx').on(table.chatId, table.isActive),
    index('ChatParticipant_lastMessageAt_idx').on(table.lastMessageAt),
    index('ChatParticipant_userId_isActive_idx').on(table.userId, table.isActive),
  ]
);
...
export const dmAcceptances = pgTable(
  ...
  (table) => [
    index('DMAcceptance_status_createdAt_idx').on(table.status, table.createdAt),
...
export const groupChatMemberships = pgTable(
  ...
  (table) => [
    ...
    index('GroupChatMembership_chatId_isActive_idx').on(table.chatId, table.isActive),
    index('GroupChatMembership_lastMessageAt_idx').on(table.lastMessageAt),
    index('GroupChatMembership_userId_isActive_idx').on(table.userId, table.isActive),
  ]
);
