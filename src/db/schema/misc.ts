...
export const games = pgTable(
  'Game',
  {
    ...
    currentDate: timestamp('currentDate', { mode: 'date' }).notNull().defaultNow(),
...
export const realtimeOutboxes = pgTable(
  ...
  (table) => [
    index('RealtimeOutbox_status_createdAt_idx').on(table.status, table.createdAt),
...
export const parodyHeadlinesRelations = relations(parodyHeadlines, ({ one }) => ({
