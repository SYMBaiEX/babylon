 ...
 *
 * Example:
 *   import type { User, Post, Market } from '@/db/model-types';
 *
...
export type ActorRelationship = InferSelectModel<typeof schema.actorRelationships>;
...
export type PredictionPriceHistory = InferSelectModel<typeof schema.predictionPriceHistories>;
...
export type GroupChatMembership = InferSelectModel<typeof schema.groupChatMemberships>;
...
export type AgentPerformanceMetrics = InferSelectModel<typeof schema.agentPerformanceMetrics>;
...
export type AgentPointsTransaction = InferSelectModel<typeof schema.agentPointsTransactions>;
export type AgentTrade = InferSelectModel<typeof schema.agentTrades>;
export type ExternalAgentConnection = InferSelectModel<typeof schema.externalAgentConnections>;
...
export type BalanceTransaction = InferSelectModel<typeof schema.balanceTransactions>;
export type PointsTransaction = InferSelectModel<typeof schema.pointsTransactions>;
...
export type TwitterOAuthToken = InferSelectModel<typeof schema.twitterOAuthTokens>;
export type OnboardingIntent = InferSelectModel<typeof schema.onboardingIntents>;
...
export type ProfileUpdateLog = InferSelectModel<typeof schema.profileUpdateLogs>;
...
export type OracleCommitment = InferSelectModel<typeof schema.oracleCommitments>;
export type OracleTransaction = InferSelectModel<typeof schema.oracleTransactions>;
...
export type CharacterMapping = InferSelectModel<typeof schema.characterMappings>;
export type OrganizationMapping = InferSelectModel<typeof schema.organizationMappings>;
export type ModerationEscrow = InferSelectModel<typeof schema.moderationEscrows>;
...
export type NewActorRelationship = InferInsertModel<typeof schema.actorRelationships>;
...
export type NewPredictionPriceHistory = InferInsertModel<typeof schema.predictionPriceHistories>;
export type NewChat = InferInsertModel<typeof schema.chats>;
export type NewChatParticipant = InferInsertModel<typeof schema.chatParticipants>;
...
export type NewGroupChatMembership = InferInsertModel<typeof schema.groupChatMemberships>;
export type NewUserInteraction = InferInsertModel<typeof schema.userInteractions>;
export type NewAgentRegistry = InferInsertModel<typeof schema.agentRegistries>;
export type NewAgentCapability = InferInsertModel<typeof schema.agentCapabilities>;
...
export type NewAgentPerformanceMetrics = InferInsertModel<typeof schema.agentPerformanceMetrics>;
export type NewAgentGoal = InferInsertModel<typeof schema.agentGoals>;
export type NewAgentGoalAction = InferInsertModel<typeof schema.agentGoalActions>;
export type NewAgentPointsTransaction = InferInsertModel<typeof schema.agentPointsTransactions>;
export type NewAgentTrade = InferInsertModel<typeof schema.agentTrades>;
export type NewExternalAgentConnection = InferInsertModel<typeof schema.externalAgentConnections>;
...
export type NewBalanceTransaction = InferInsertModel<typeof schema.balanceTransactions>;
export type NewPointsTransaction = InferInsertModel<typeof schema.pointsTransactions>;
export type NewUserActorFollow = InferInsertModel<typeof schema.userActorFollows>;
...
export type NewUserGroupInvite = InferInsertModel<typeof schema.userGroupInvites>;
export type NewUserGroupMember = InferInsertModel<typeof schema.userGroupMembers>;
...
export type NewTwitterOAuthToken = InferInsertModel<typeof schema.twitterOAuthTokens>;
export type NewOnboardingIntent = InferInsertModel<typeof schema.onboardingIntents>;
...
export type NewProfileUpdateLog = InferInsertModel<typeof schema.profileUpdateLogs>;
...
export type NewBenchmarkResult = InferInsertModel<typeof schema.benchmarkResults>;
...
export type NewOracleCommitment = InferInsertModel<typeof schema.oracleCommitments>;
export type NewOracleTransaction = InferInsertModel<typeof schema.oracleTransactions>;
export type NewRealtimeOutbox = InferInsertModel<typeof schema.realtimeOutboxes>;
...
export type NewCharacterMapping = InferInsertModel<typeof schema.characterMappings>;
export type NewOrganizationMapping = InferInsertModel<typeof schema.organizationMappings>;
export type NewModerationEscrow = InferInsertModel<typeof schema.moderationEscrows>;
...
export type BalanceTransactionWithUser = BalanceTransaction & {
  user?: Pick<User, 'id' | 'username' | 'displayName' | 'profileImageUrl' | 'isActor'> | null;
};

/** ModerationEscrow with relations */
export type ModerationEscrowWithRelations = ModerationEscrow & {
  recipient?: Pick<User, 'id' | 'username' | 'displayName' | 'profileImageUrl'> | null;
