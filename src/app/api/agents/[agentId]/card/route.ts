  ...
  try {
    ...
    const agentCard: AgentCard = {
      ...
      endpoints: {
        ...
        a2a: agent.capabilities.a2aEndpoint || `${baseUrl}/api/agents/${agentId}/a2a`,
        // MCP HTTP endpoint (future implementation)
        mcp: agent.capabilities.mcpEndpoint || `${baseUrl}/api/agents/${agentId}/mcp`,
    ...
    logger.info(`Agent card retrieved for ${agentId}`, {
