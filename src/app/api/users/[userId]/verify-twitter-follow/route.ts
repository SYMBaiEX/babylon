...
export const POST = withErrorHandling(async (
  ...
  if (!authUser.dbUserId) {
    throw new AuthorizationError('User profile not found. Please complete onboarding first.', 'twitter-follow-verification', 'create');
  }
  ...
  if (authUser.dbUserId !== canonicalUserId) {
    throw new AuthorizationError('You can only claim your own Twitter follow reward', 'twitter-follow-verification', 'create');
  }
  ...
  const pointsResult = await PointsService.awardTwitterFollow(canonicalUserId);
