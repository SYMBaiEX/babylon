...
import { db, pointsTransactions, eq, desc } from '@/db'
...
export const GET = withErrorHandling(async (
  ...
  if (!authUser.dbUserId) {
    throw new AuthorizationError('User profile not found. Please complete onboarding first.', 'points-history', 'read');
  }
  ...
  if (authUser.dbUserId !== canonicalUserId) {
    throw new AuthorizationError('You can only view your own points history', 'points-history', 'read');
  }
